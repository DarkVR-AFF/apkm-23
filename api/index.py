...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "7144C"  # Playfab Title Id
        self.SecretKey: str = "PRG8NSQYEJDMXMY8Y1M8HSQB69MBF965Y44BDP7CGZCFYOSFTT"  # Playfab Secret Key
        self.ApiKey: str = "OC|1046431108564276|0efa1bc6c45aa3eeb1dd16d7a7347063"  # App Api Key (Oculus/Graph API)
    ...
    return """
        <html>
            ...
            <body style="font-family: 'Inter', sans-serif; background: linear-gradient(to bottom, #004d00, #00cc00); color: white; text-align: center; padding: 50px;">
                ...
                <p style="font-size: 18px;">AFF TAG Backend Server Running Smoothly!</p>
...
def titledata():
    response_data = {
        ...
        "BundleBoardSign": "<color=#ff4141>DISCORD.GG/JvxakEGtpn</color>",
        "BundleKioskButton": "<color=#ff4141>DISCORD.GG/JvxakEGtpn</color>",
        "BundleKioskSign": "<color=#ff4141>DISCORD.GG/JvxakEGtpn</color>",
        "BundleLargeSign": "<color=#ff4141>DISCORD.GG/JvxakEGtpn</color>",
        ...
        "MOTD": "<color=#FFC0CB>WELCOME TO AFF TAG!</color>\n\n<color=#0099c2>CURRENT UPDATE: XMAS 23</color>\n<color=#cacfd2>BOOST THE DISCORD FOR ALL COSMETICS (EXCLUDING STAFF COS)</color>\n<color=#41ff80>YANDERE MADE THIS MOTD</color>\n<color=#6417ff>OUR DEVELOPERS ARE: FATAL & CASHSMILE</color>\n<color=#ac1a00>CREDITS FOR GAMES OG OS: VIPER</color>\n\n<color=#91A3B0>discord.gg/JvxakEGtpn</color>",
        "TOBAlreadyOwnCompTxt": "DISCORD.GG/JvxakEGtpn",
        "TOBAlreadyOwnPurchaseBundle": "AFF TAG",
        "TOBDefCompTxt": "DISCORD.GG/JvxakEGtpn",
        "TOBDefPurchaseBtnDefTxt": "AFF TAG",
        # Legal and Versions
        "EnableCustomAuthentication": True,
        "LatestPrivacyPolicyVersion": "2024.09.20",
        "LatestTOSVersion": "2024.09.20",
        "TOS_2024.09.20": "DISCORD.GG/JvxakEGtpn",
        ...
        "NewsFeedUrl": "https://discord.gg/JvxakEGtpn",
        ...
        "BanAppealUrl": "https://discord.gg/JvxakEGtpn",
        ...
        "FeedbackSubmissionUrl": "https://discord.gg/JvxakEGtpn/feedback"
    }
